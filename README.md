...
## Посмотреть готовые протоколы — без установки моделей

**Откройте документы прямо на GitHub:** скачивать ИИ-модели, устанавливать Ollama и запускать приложение не нужно.

- [Протокол № 1 — модернизация производственной площадки](docs/protocols/01-chemical-industry.md): саммари, решения, 6 поручений с исполнителями и сроками.
- [Протокол № 2 — пилот цифрового документооборота](docs/protocols/02-operational-meeting.md): решения, 6 поручений, риски и ссылки на реплики-основания.

Это **вымышленные учебные примеры**, написанные вручную для демонстрации структуры результата. [Все готовые протоколы](docs/protocols/README.md).
